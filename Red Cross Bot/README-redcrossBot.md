...
3. Give the bot a handle (ex: `redcrossBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://redcrossbot.azurewebsites.net/api/messages`
